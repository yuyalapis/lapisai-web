        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
              ...
              2025-03-30: サイトをとりあえず動くようにしました。このように頻繁にトップがiPadなどから更新できるサイトというのも珍しいのですが、構築まわりで何かございましたら yuyasatowork@gmail.com までご連絡ください(とりあえずgmailです)。アホな金額とか請求しませんので。ちなみにReactで動いております。- さぶや
            </p>
