...
function App() {
  ...
  return (
    <div className="bg-white ">
      ...
      <div className="relative isolate px-6 my-14 lg:mx-8 bg-gradient-to-br from-sky-100 via-slate-50 to-white ">
        <div className="mx-auto max-w-2xl py-16 sm:py-48 lg:py-28">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-xl font-semibold text-gray-700 sm:text-xl">
              いい栞が、ない<br />
              本当にない<br />
              <br />
            ...
            <div className="text-left">
              <p className="mt-8 text-pretty text-xl font-semibold text-gray-700 sm:text-xl/8">
              
                [今日の開発日記] <br />
                2025-03-29: プロジェクト始動 - さぶや<br /><br />
                2025-03-30: サイトをとりあえず動くようにしました。<br />このように頻繁にトップが更新できるサイトというのも珍しいのですが、構築まわりで何かございましたら yuya@lapisai.com までご連絡ください。<br />格安で承ります。ちなみにReactで動いております。- さぶや<br />
