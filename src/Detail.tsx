      ...
      <div className="fixed z-50 w-full h-16 bottom-4">
                ...
                <form className="max-w-md mx-auto">   
                    <div className="relative flex items-right">
                        ...
                        <button type="submit" onClick={(e) => { e.preventDefault(); window.location.href = "https://lapisai.com/search/" + search_term}} className="text-white mx-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
